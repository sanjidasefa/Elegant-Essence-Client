...
const Decorators = ({ limit }) => {
  ...
  return (
    <div className="bg-white lg:p-20 p-10 rounded-2xl">
      <h1 className="font-bold text-3xl md:text-5xl mb-5 text-cyan-800">
        Our Creative Decorators
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {iflimit.map((decorator) => {
          return (
            <div key={decorator._id}>
              <div className="bg-white shadow-2xl my-3 h-11/12 rounded-2xl p-5 ">
                  ...
                  <div>
                    <div className="">
                      ...
                      <div className="flex  items-center gap-1">
                        ...
                        <p className="text-gray-500 my-3 flex gap-3 ">
                          {" "}
                          {decorator.rating}
                        </p>
                      </div>
                ...
                <div className="flex justify-between mt-3 text-cyan-500">
                  ...
                  <p className="">Total Reviews : {decorator.totalReviews}</p>
                </div>
              </div>
            </div>
          );
