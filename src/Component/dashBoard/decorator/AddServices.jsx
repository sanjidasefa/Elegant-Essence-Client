...
const AddServices = () => {
  ...
  return (
    <>
    <div className="">
      <h1 className="text-4xl  font-bold text-center my-8 ">Add Your Service </h1>
    </div>
          ...
          <form onSubmit={handleSubmit(onSubmitSign, onError)}>
            <fieldset className="fieldset ">
              <legend className="fieldset-legend">
                For Add Your Service Please Fill the From{" "}
              </legend>
              ...
              {errors.photo?.type === "required" && (
                <p className="text-red-600">Please Enter Your Service Photo</p>
              )}
