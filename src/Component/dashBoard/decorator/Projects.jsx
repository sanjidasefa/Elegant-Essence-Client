              ...
              <div className="flex gap-10">
                ...
                <div>
                  ...
                  <div className="flex justify-between text-cyan-400">
                    <p className="flex justify-center text-xl font-bold  items-center">
                      <MdOutlineAttachMoney />
          ...
          >
            <div className="modal-box bg-white text-cyan-700">
              <h3 className="font-bold ">
                {" "}
                Fill The Form For Book Our Service
              </h3>
              <p className="py-4 text-2xl text-cyan-800">
                {selectProject.serviceName}
              </p>
              <div>
