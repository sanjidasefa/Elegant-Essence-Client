...
const Banner = () => {
  return (
    <div className='p-10  bg-white md:flex md:gap-20 items-center'>
      <div>
        <h1 className='text-2xl md:text-left  md:text-4xl mb-4 text-cyan-800  text-center  font-bold '>We Are Celebrating Our 18th Anniversary In the best interior design and Construction Industry In BD</h1>
